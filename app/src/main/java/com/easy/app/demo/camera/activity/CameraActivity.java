...
import com.easy.app.demo.camera.view.CameraHelper;
import com.easy.app.demo.camera.view.MaskSurfaceView;

public class CameraActivity extends BaseActivity<TitleBar> implements CameraHelper.CaptureCallback, View.OnClickListener {
