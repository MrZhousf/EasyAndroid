package com.easy.app.demo.video;
 ...
 * 视频模块
 */
public class VideoActivity extends BaseActivity<TitleBar> implements View.OnClickListener,SurfaceHolder.Callback, IMediaPlayer.OnPreparedListener,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.playBtn:
                if(!isPrepared){
                    Util.Toast.show(this,"正在初始化播放器，请稍后再试。");
                    return ;
                }
